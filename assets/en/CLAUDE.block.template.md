# CLAUDE.md auto-load block

Append this complete marked block to the effective `CLAUDE.md`; replace the full existing block with the same markers. Never keep duplicates.
